...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UsersDTO user = dao.checkLogin(userID, passwod);
            ...
            if(user != null){
                ...
                if("AD".equals(user.getRoleID())){
                    ...
                    session.setAttribute("MESSAGE", "Your role is not support");
                }
            }else{
                session.setAttribute("MESSAGE", "Inconrrect UserID or Password");
            }
        } catch (Exception e) {
